        ...
        <div class="col-sm-5">
          <div class="con-info">
            ...
            <ul>
              ...
              <li class="email">
                <p>mdrahmat@gmail.com</p>
                <p>anchal@gmail.com</p>              </li>
            </ul>
          </div>
        </div>
      </div>
  ...
  <div class="rights style-2">
    <div class="container">
      <p>© <?php echo date("Y"); ?> Hospital Management System - Template by M_ADNAN & Application Developed By <span style="color: white">teams vit chennai</span></p>
    </div>
  </div>
